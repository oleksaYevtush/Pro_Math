  ...
  return (
    <div id="contact" className='flex flex-col justify-center mt-5'>
        ...
        <div className='grid grid-cols-1 px-10 md:grid-cols-2 justify-evenly md:px-44'>
           ...
           <button className='transition-all ease-in-out hover:scale-110 bg-purple-500 flex flex-row items-center justify-center text-[14px]  py-1 mt-5 text-[#f8efe6] rounded-md'>
           Відправити
